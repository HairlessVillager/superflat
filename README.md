...
- [ ] Complete Rust refactor / Introduction of streaming computation.
...
Ensure you have [Git](https://git-scm.com/install/) and [uv](https://docs.astral.sh/uv/getting-started/installation/) installed on your system.
