...
- Modified the [block state](https://minecraft.wiki/w/Block_states) or [biome](https://minecraft.wiki/w/Biome#Data_values) list, including adding, removing, or replacing items
